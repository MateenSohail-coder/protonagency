...
export default function PricingPage() {
  ...
  return (
    <>
      <Navbar />
      <section className="py-20 md:py-24 lg:py-28 px-6 sm:px-8 lg:px-12 xl:px-20 pt-32 md:pt-40 lg:pt-48">
        {/* Fixed Header - Always Visible */}
        <motion.div
          className="max-w-4xl mx-auto text-left mb-16 lg:mb-20 pt-12 md:pt-16"
          initial="hidden"
        ...
        >
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl pb-9 font-black bg-gradient-to-r from-gray-900 via-black/90 to-gray-900 bg-clip-text text-transparent mb-6 leading-[0.9] tracking-tight"
          >
            Pricing
          </motion.h1>
        ...
        <div className="max-w-3xl mx-auto space-y-8 lg:space-y-10">
          {pricing.map((plan, index) => (
            <motion.div
              key={plan.title}
              className="group relative bg-gradient-to-br from-[#EEFF00] to-[#CCFF00] border-2 border-black/10 p-8 lg:p-10 rounded-2xl transition-all duration-500 hover:-translate-y-2 hover:border-black/20 hover:shadow-2xl hover:shadow-[#EEFF00]/30"
              initial="hidden"
              animate={isVisible ? "visible" : "hidden"}
              variants={itemVariants}
              custom={index}
